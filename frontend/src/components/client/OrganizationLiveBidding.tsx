...
export const OrganizationLiveBidding: React.FC<OrganizationLiveBiddingProps> = ({ 
  ...
  const handleSubmitBid = async (e: React.FormEvent) => {
    ...
    const organizationName = user?.organizationProfile?.companyName;
    if (!organizationName) {
      setError('Organization name not found. Please complete your profile.');
      showErrorToast('Please complete your organization profile');
      return;
    }
    ...
    try {
      ...
      await apiClient.post(`/api/auctions/${auctionId}/bids`, 
        { amount },
        { 
          headers: { 
            'X-Organization-Id': _organizationId.toString(),
